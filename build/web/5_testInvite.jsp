...
<html><meta name="viewport" content="width=device-width, initial-scale=1.0">
    ...
    <body>
        ...
        <div class="test" style="margin-left:400px; margin-top:80px;height:90px;">
            ...
            <font color='Black'><h1>Send Invitation</h1>
            <br>
            <br>
            <form action="SendMail_1.jsp" method="post" >
                <h3 style="font-weight: bold">Select Network for invitee</h3><br>
                <br>
                <br>
                <%
      ...
      <%     con.close();
          ...
          %> 
                ...
                <div class="u-form-group1">
                    <input type="network_name" required name="invite_user" placeholder="Enter Email id of person">
                </div>
                <br>
                <div class="u-form-group1">
                    <button id ="btnprofile">Send Invitation</button>
                </div>
            </form>
        </div>
        <div class="chat-sidebar"><div id="chatnamebox" class="chat-sidebar">   
